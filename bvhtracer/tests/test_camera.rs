...
#[test]
fn test_camera_top_left_corner_eye11() {
    let camera = camera1();
...
#[test]
fn test_camera_top_left_corner_world11() {
    let camera = camera1();
...
#[test]
fn test_camera_bottom_left_corner_eye11() {
    let camera = camera1();
    let expected = Vector3::new(-4_f64, -3_f64, -1_f64);
...
#[test]
fn test_camera_bottom_left_corner_world11() {
    let camera = camera1();
    let expected = Vector3::new(-4_f64, 3_f64, -4_f64);
    let result = {
...
#[test]
fn test_camera_top_right_corner_eye11() {
    let camera = camera1();
    let expected = Vector3::new(4_f64, 3_f64, -1_f64);
...
#[test]
fn test_camera_top_right_corner_world11() {
    let camera = camera1();
    let expected = Vector3::new(4_f64, -3_f64, -4_f64);
    let result = {
...
#[test]
fn test_camera_bottom_right_corner_eye11() {
    let camera = camera1();
    let expected = Vector3::new(4_f64, -3_f64, -1_f64);
...
#[test]
fn test_camera_bottom_right_corner_world11() {
    let camera = camera1();
    let expected = Vector3::new(4_f64, 3_f64, -4_f64);
    let result = {
...
#[test]
fn test_camera_get_ray_top_left_corner11() {
    let camera = camera1();
...
#[test]
fn test_camera_get_ray_bottom_left_corner11() {
    let camera = camera1();
    let ray_origin = Vector3::new(0_f64, 0_f64, -5_f64);
    let ray_direction = (Vector3::new(-4_f64, 3_f64, -4_f64) - ray_origin).normalize();
    let expected = Ray::from_origin_dir(ray_origin, ray_direction);
...
#[test]
fn test_camera_get_ray_top_right_corner11() {
    let camera = camera1();
    let ray_origin = Vector3::new(0_f64, 0_f64, -5_f64);
    let ray_direction = (Vector3::new(4_f64, -3_f64, -4_f64) - ray_origin).normalize();
    let expected = Ray::from_origin_dir(ray_origin, ray_direction);
...
#[test]
fn test_camera_get_ray_bottom_right_corner11() {
    let camera = camera1();
    let ray_origin = Vector3::new(0_f64, 0_f64, -5_f64);
    let ray_direction = (Vector3::new(4_f64, 3_f64, -4_f64) - ray_origin).normalize();
    let expected = Ray::from_origin_dir(ray_origin, ray_direction);
...
#[test]
fn test_camera_get_ray_centroid11() {
    let camera = camera1();
    let ray_origin = Vector3::new(0_f64, 0_f64, -5_f64);
...
#[test]
fn test_camera_forward_axis_world11() {
    let camera = camera1();
...
#[test]
fn test_camera_right_axis_world11() {
    let camera = camera1();
...
#[test]
fn test_camera_up_axis_world11() {
    let camera = camera1();
...
#[test]
fn test_camera_forward_axis_world12() {
    let camera = camera1();
...
#[test]
fn test_camera_right_axis_world12() {
    let camera = camera1();
...
#[test]
fn test_camera_up_axis_world12() {
    let camera = camera1();
...
#[test]
fn test_camera_origin_eye_to_world11() {
    let camera = camera1();
...
#[test]
fn test_camera_origin_world_to_eye11() {
    let camera = camera1();
...
#[test]
fn test_camera_top_left_corner_eye21() {
    let camera = camera2();
    let expected = Vector3::new(-4_f64, 3_f64, -1_f64);
    let result = camera.top_left_eye();
...
#[test]
fn test_camera_top_left_corner_world21() {
    let camera = camera2();
    let expected = Vector3::new(-4_f64, 3_f64, 4_f64);
    let result = {
        let top_left_eye = camera.top_left_eye().extend(1_f64);
...
#[test]
fn test_camera_bottom_left_corner_eye21() {
    let camera = camera2();
    let expected = Vector3::new(-4_f64, -3_f64, -1_f64);
    let result = camera.bottom_left_eye();
...
#[test]
fn test_camera_bottom_left_corner_world21() {
    let camera = camera2();
    let expected = Vector3::new(-4_f64, -3_f64, 4_f64);
    let result = {
        let bottom_left_eye = camera.bottom_left_eye().extend(1_f64);
...
#[test]
fn test_camera_top_right_corner_eye21() {
    let camera = camera2();
    let expected = Vector3::new(4_f64, 3_f64, -1_f64);
    let result = camera.top_right_eye();
...
#[test]
fn test_camera_top_right_corner_world21() {
    let camera = camera2();
    let expected = Vector3::new(4_f64, 3_f64, 4_f64);
    let result = {
        let top_right_eye = camera.top_right_eye().extend(1_f64);
...
#[test]
fn test_camera_bottom_right_corner_eye21() {
    let camera = camera2();
    let expected = Vector3::new(4_f64, -3_f64, -1_f64);
    let result = camera.bottom_right_eye();
...
#[test]
fn test_camera_bottom_right_corner_world21() {
    let camera = camera2();
    let expected = Vector3::new(4_f64, -3_f64, 4_f64);
    let result = {
        let bottom_right_eye = camera.bottom_right_eye().extend(1_f64);
...
#[test]
fn test_camera_get_ray_top_left_corner21() {
    let camera = camera2();
    let ray_origin = Vector3::new(0_f64, 0_f64, 5_f64);
    let ray_direction = (Vector3::new(-4_f64, 3_f64, 4_f64)- ray_origin).normalize();
    let expected = Ray::from_origin_dir(ray_origin, ray_direction);
...
#[test]
fn test_camera_get_ray_bottom_left_corner21() {
    let camera = camera2();
    let ray_origin = Vector3::new(0_f64, 0_f64, 5_f64);
    let ray_direction = (Vector3::new(-4_f64, -3_f64, 4_f64) - ray_origin).normalize();
    let expected = Ray::from_origin_dir(ray_origin, ray_direction);
...
#[test]
fn test_camera_get_ray_top_right_corner21() {
    let camera = camera2();
    let ray_origin = Vector3::new(0_f64, 0_f64, 5_f64);
    let ray_direction = (Vector3::new(4_f64, 3_f64, 4_f64) - ray_origin).normalize();
    let expected = Ray::from_origin_dir(ray_origin, ray_direction);
...
#[test]
fn test_camera_get_ray_bottom_right_corner21() {
    let camera = camera2();
    let ray_origin = Vector3::new(0_f64, 0_f64, 5_f64);
    let ray_direction = (Vector3::new(4_f64, -3_f64, 4_f64) - ray_origin).normalize();
    let expected = Ray::from_origin_dir(ray_origin, ray_direction);
...
#[test]
fn test_camera_get_ray_centroid21() {
    let camera = camera2();
    let ray_origin = Vector3::new(0_f64, 0_f64, 5_f64);
    let ray_direction = Vector3::new(0_f64, 0_f64, -1_f64);
    let expected = Ray::from_origin_dir(ray_origin, ray_direction);
...
#[test]
fn test_camera_forward_axis_world21() {
    let camera = camera2();
    let expected = -Vector3::unit_z();
    let result = {
        let forward_eye = camera.forward_axis_eye();
...
#[test]
fn test_camera_right_axis_world21() {
    let camera = camera2();
    let expected = Vector3::unit_x();
    let result = {
        let right_eye = camera.right_axis_eye();
...
#[test]
fn test_camera_up_axis_world21() {
    let camera = camera2();
    let expected = Vector3::unit_y();
    let result = {
        let up_eye = camera.up_axis_eye();
...
#[test]
fn test_camera_forward_axis_world22() {
    let camera = camera2();
    let expected = camera.forward_axis_world();
    let result = {
        let forward_eye = camera.forward_axis_eye();
...
#[test]
fn test_camera_right_axis_world22() {
    let camera = camera2();
    let expected = camera.right_axis_world();
    let result = {
        let right_eye = camera.right_axis_eye();
...
#[test]
fn test_camera_up_axis_world22() {
    let camera = camera2();
    let expected = camera.up_axis_world();
    let result = {
        let up_eye = camera.up_axis_eye();
...
#[test]
fn test_camera_origin_eye_to_world21() {
    let camera = camera2();
    let expected = Vector3::new(0_f64, 0_f64, 5_f64);
    let result = {
        let origin_eye = Vector3::zero();
...
#[test]
fn test_camera_origin_world_to_eye21() {
    let camera = camera2();
    let expected = Vector3::zero();
    let result = {
        let origin_world = Vector3::new(0_f64, 0_f64, 5_f64);
